...
namespace Dap.Tests.Integration
{
    public class CustomRequestsTests : DebugAdapterProtocolTestBase
    {
        ...
        [Fact]
        public async Task Should_Support_Custom_Attach_Request()
        {
        ...
        [Fact]
        public async Task Should_Support_Custom_Attach_Request_Receiving_Regular_Request()
        {
        ...
        [Fact]
        public async Task Should_Support_Custom_Attach_Request_Using_Extension_Data()
        {
            var fake = Substitute.For<Func<CustomAttachRequestArguments, CancellationToken, Task<AttachResponse>>>();
            var (client, server) = await Initialize(options => {
            }, options => { options.OnAttach(fake); });
        ...
        [Fact]
        public async Task Should_Support_Custom_Launch_Request_Receiving_Regular_Request()
        {
        ...
        [Fact]
        public async Task Should_Support_Custom_Launch_Request_Using_Extension_Data()
        {
            var fake = Substitute.For<Func<CustomLaunchRequestArguments, CancellationToken, Task<LaunchResponse>>>();
            var (client, server) = await Initialize(options => {
            }, options => { options.OnLaunch(fake); });
