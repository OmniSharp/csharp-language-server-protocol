...
namespace Lsp.Tests
{
    public class LanguageServerServiceCollectionSupportTests
    {
        ...
        public LanguageServerServiceCollectionSupportTests(ITestOutputHelper testOutputHelper)
        {
        ...
        public void Should_Bootstrap_Multiple_Servers_Through_Service_Collection()
        {
            ...
            cts.CancelAfter(TimeSpan.FromSeconds(30));
            var services = new ServiceCollection()
                .AddLanguageServer("serial", options => {
                    var pipe = new Pipe();
                    options
                        .WithInput(pipe.Reader)
                        .WithOutput(pipe.Writer)
                ...
                .AddLanguageServer("parallel", options => {
                    var pipe = new Pipe();
                    options
                        .WithInput(pipe.Reader)
                        .WithOutput(pipe.Writer)
