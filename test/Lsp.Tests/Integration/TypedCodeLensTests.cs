...
namespace Lsp.Tests.Integration
{
    public class TypedCodeLensTests : LanguageProtocolTestBase
    {
        ...
        public async Task Should_Aggregate_With_All_Related_Handlers()
        {
            ...
            var (client, server) = await Initialize(
                options => { }, options => {
                    ...
                    options.OnCodeLens<Data>((codeLensParams) => {
                            return Task.FromResult(new CodeLensContainer<Data>(new CodeLens<Data>() {
                                Command = new Command() {
                                    Name = "data-a",
                    ...
                    options.OnCodeLens<Nested>((codeLensParams) => {
                            return Task.FromResult(new CodeLensContainer<Nested>(new CodeLens<Nested>() {
                                Command = new Command() {
                                    Name = "nested-b",
                                    Arguments = JArray.FromObject(new object[] { 1, "2", false })
                                },
                    ...
                    options.OnCodeLens((codeLensParams) => {
            ...
            var codeLens = await client.RequestCodeLens(new CodeLensParams() {
        ...
        public async Task Should_Resolve_With_Data_Capability()
        {
            ...
            var (client, server) = await Initialize(
                options => { }, options => {
                    options.OnCodeLens<Data>((codeLensParams, capability, token) => {
                        return Task.FromResult(new CodeLensContainer<Data>(new CodeLens<Data>() {
                            Command = new Command() {
                                Name = "execute-a",
                                Arguments = JArray.FromObject(new object[] { 1, "2", false })
        ...
        public async Task Should_Resolve_With_Partial_Data_Capability()
        {
            ...
            var (client, server) = await Initialize(
                options => { }, options => {
                    options.OnCodeLens<Data>((codeLensParams, observer, capability, token) => {
                        var a = new CodeLensContainer<Data>(new CodeLens<Data>() {
                            Command = new Command() {
                                Name = "execute-a",
                                Arguments = JArray.FromObject(new object[] { 1, "2", false })
                            },
        ...
        public async Task Should_Resolve_With_Data_CancellationToken()
        {
            ...
            var (client, server) = await Initialize(
                options => { }, options => {
                    options.OnCodeLens<Data>((codeLensParams, token) => {
                        return Task.FromResult(new CodeLensContainer<Data>(new CodeLens<Data>() {
                            Command = new Command() {
                                Name = "execute-a",
                                Arguments = JArray.FromObject(new object[] { 1, "2", false })
        ...
        public async Task Should_Resolve_With_Partial_Data_CancellationToken()
        {
            ...
            var (client, server) = await Initialize(
                options => { }, options => {
                    options.OnCodeLens<Data>((codeLensParams, observer, token) => {
                        var a = new CodeLensContainer<Data>(new CodeLens<Data>() {
                            Command = new Command() {
                                Name = "execute-a",
                                Arguments = JArray.FromObject(new object[] { 1, "2", false })
        ...
        public async Task Should_Resolve_With_Partial_Data()
        {
            ...
            var (client, server) = await Initialize(
                options => { }, options => {
                    options.OnCodeLens<Data>((codeLensParams, observer) => {
                        var a = new CodeLensContainer<Data>(new CodeLens<Data>() {
                            Command = new Command() {
                                Name = "execute-a",
                                Arguments = JArray.FromObject(new object[] { 1, "2", false })
        ...
        public async Task Should_Resolve_Capability()
        {
            ...
            var (client, server) = await Initialize(
                options => { }, options => {
                    options.OnCodeLens((codeLensParams, capability, token) => {
                        return Task.FromResult(new CodeLensContainer(new CodeLens() {
                            Command = new Command() {
                                Name = "execute-a",
                                Arguments = JArray.FromObject(new object[] { 1, "2", false })
        ...
        public async Task Should_Resolve_Partial_Capability()
        {
            ...
            var (client, server) = await Initialize(
                options => { }, options => {
                    options.OnCodeLens((codeLensParams, observer, capability, token) => {
                        var a = new CodeLensContainer(new CodeLens() {
                            Command = new Command() {
                                Name = "execute-a",
                                Arguments = JArray.FromObject(new object[] { 1, "2", false })
                            },
        ...
        public async Task Should_Resolve_CancellationToken()
        {
            ...
            var (client, server) = await Initialize(
                options => { }, options => {
                    options.OnCodeLens((codeLensParams, token) => {
                        return Task.FromResult(new CodeLensContainer(new CodeLens() {
                            Command = new Command() {
                                Name = "execute-a",
                                Arguments = JArray.FromObject(new object[] { 1, "2", false })
        ...
        public async Task Should_Resolve_Partial_CancellationToken()
        {
            ...
            var (client, server) = await Initialize(
                options => { }, options => {
                    options.OnCodeLens((codeLensParams, observer, token) => {
                        var a = new CodeLensContainer(new CodeLens() {
                            Command = new Command() {
                                Name = "execute-a",
                                Arguments = JArray.FromObject(new object[] { 1, "2", false })
        ...
        public async Task Should_Resolve_Partial()
        {
            ...
            var (client, server) = await Initialize(
                options => { }, options => {
                    options.OnCodeLens((codeLensParams, observer) => {
                        var a = new CodeLensContainer(new CodeLens() {
                            Command = new Command() {
                                Name = "execute-a",
                                Arguments = JArray.FromObject(new object[] { 1, "2", false })
