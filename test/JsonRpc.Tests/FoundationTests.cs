...
namespace JsonRpc.Tests
{
    public class FoundationTests
    {
        ...
        public void All_Create_From_Methods_Should_Work(ActionDelegate actionDelegate) => actionDelegate.Method.Should().NotThrow();
        ...
        private class MissingInputData : TheoryData<ActionDelegate>
        {
        ...
        private class MissingOutputData : TheoryData<ActionDelegate>
        {
