...
namespace OmniSharp.Extensions.DebugAdapter.Protocol.Models
{
    ...
    public class DisassembledInstruction
    {
        ...
        /// </summary>
        [JsonIgnore(Condition = JsonIgnoreCondition.WhenNull)] public string InstructionBytes { get; set; }
        ...
        /// </summary>
        [JsonIgnore(Condition = JsonIgnoreCondition.WhenNull)] public string Symbol { get; set; }
        ...
        /// </summary>
        [JsonIgnore(Condition = JsonIgnoreCondition.WhenNull)] public Source Location { get; set; }
