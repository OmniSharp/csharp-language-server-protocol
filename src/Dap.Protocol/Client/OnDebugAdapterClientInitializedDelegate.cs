...
namespace OmniSharp.Extensions.DebugAdapter.Protocol.Client
{
    ...
    /// </summary>
    public delegate Task OnDebugAdapterClientInitializedDelegate(
        IDebugAdapterClient client, InitializeRequestArguments request, InitializeResponse response, CancellationToken cancellationToken
    );
}
