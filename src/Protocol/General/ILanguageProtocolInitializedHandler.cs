...
namespace OmniSharp.Extensions.LanguageServer.Protocol.General
{
    ...
    [GenerateHandlerMethods(typeof(ILanguageServerRegistry), MethodName = "OnLanguageProtocolInitialized"), GenerateRequestMethods(typeof(ILanguageClient), MethodName = "SendLanguageProtocolInitialized")]
