...
namespace OmniSharp.Extensions.LanguageServer.Protocol.Document
{
    ...
    public static class TextDocumentSyncExtensions
    {
        ...
        private class DelegatingHandler : TextDocumentSyncHandler
        {
            ...
            private SynchronizationCapability _capability = null!;
            ...
            public DelegatingHandler(
                ...
                (r, c, ct) => { onOpenHandler(r, c, ct); return Task.CompletedTask; },
                (r, c, ct) => { onCloseHandler(r, c, ct); return Task.CompletedTask; },
                (r, c, ct) => { onChangeHandler(r, c, ct); return Task.CompletedTask; },
                (r, c, ct) => { onSaveHandler(r, c, ct); return Task.CompletedTask; },
