...
namespace OmniSharp.Extensions.LanguageServer.Protocol
{
    namespace Models
    {
        ...
        {
            public CompletionList(bool isIncomplete): this(isIncomplete, Enumerable.Empty<CompletionItem>())
            {
                IsIncomplete = isIncomplete;
            }

            public CompletionList(bool isIncomplete, IEnumerable<CompletionItem> items): base(items)
            {
                IsIncomplete = isIncomplete;
            }
            ...
            public static CompletionList Create<T>(CompletionList<T> list) where T : HandlerIdentity? , new()
                => new (list.IsIncomplete, list.Items.Select(CompletionItem.From));
        }
